    ...
    <div class="flex flex-col xl:grid xl:grid-cols-3 lg:gap-10">
      ...
      <div class="order-1 xl:order-2 xl:col-span-1">
        ...
        <CardWithIcon iconName="UserGroupIcon" class="desk_view mt-12" iconPosition="center">
            <h3 class="text-center text-main text-xl font-bold mb-4 Biotif-bold">Previously employed</h3>
...
<script>
import ShiftsTable from '@employer/ShiftsTableDashboard'
import PreviousCandidates from '@common/PreviousCandidates'

    ...
    <div class="p-4 mobile_td" >
     ...
     <div class="text-sm text-left flex items-center h-full mb-3">
      ...
      <div class="flex text-main-light items-center">
        ...
        <button @click="openTimesheet(shift.user_id, shift.candidate_id, shift.shift_id)" type="button" class="ml-auto focus:outline-none font-bold biotif-regular text-gray-400" 

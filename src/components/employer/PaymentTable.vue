...
<Loader :loader_flag="loader_flag" />
  <div class="xl:flex mb-4">
    <div class="relative lg:w-1/2 lg:mb-0 mb-2 wage_wrapper-select2" style="border-radius:100px; position:relative">
    ...
    <div class="md:col-span-2 lg:pl-3 pl-0 paymentTable_filter_section lg:flex">
      ...
      <div class="flex lg:mt-0 mt-3">
        ...
        <button @click="filter" class="self-center mt-2 lg:mt-0 lg:ml-4 m-auto btn btn-full w-20 bg-secondary hover:bg-secondary-light h-10 pb-2 biotif-regular">
            Filter
        </button>
      </div>
  </div>
    ...
    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
      <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
        <div class=" overflow-hidden border-b border-gray-200 sm:rounded-lg">
                  ...
                  <div v-if="open_sortbyFlag" class="open_sortby_list">
                      ...
                      <div class="flex cursor-pointer">
                          <img 
                              ...
                              :src="require('../../assets/images/sort.svg')"
                          />
                          <span style="color:rgb(116,117,118)" class="ml-2 text-sm font-bold">TOTAL</span>
                      </div>
                  </div>
              </div>
          ...
          <table class="large_content_shadow min-w-full divide-y divide-gray-200 bg-white " id="datatable">
            <thead class="hidden lg:table-header-group bg-gray-50">
              <tr class="hidden lg:grid lg:grid-cols-timesheet">  
...
<script>
import Row from './PaymentTable/Row.vue'
import Loader from '@common/Loader.vue'
import RowMobile from "./PaymentTable/Row_mobile";
  ...
  watch: {
   ...
   methods: {
        ...
        updateHandler() {
            ...
            setTimeout(() => {
                this.table = $("#datatable").DataTable({
                   "language": {
                      "emptyTable": "You currently have no wages pending",
                      paginate: {
                                previous: '&#x2190; Previous',
                                next: 'Next &#x2192;',
                            },
        ...
        get_paymentHistory(){
          ...
          APIgetPaymentHistory({status:'waiting'}).then((res) => {

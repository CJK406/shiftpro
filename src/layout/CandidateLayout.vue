  ...
  <div class="h-screen flex overflow-hidden bg-gray-100">
    ...
    <div class="flex flex-col w-0 flex-1 overflow-hidden">
      <div class="relative z-10 flex-shrink-0 flex h-16 bg-white shadow" style="z-index:9999999">
        <!-- <SidebarDesktop :navigation="navigation"/> -->
        <!-- Start UtilityBar -->
          <a href="#/candidate/dashboard"> <img class="h-8 lg:ml-8 ml-4 w-auto mt-4" :src="require('@/assets/sp-logo.png')" alt="ShiftPro Logo" /></a>
...
const navigation = [
  { name: 'Dashboard',  routeAlias: 'CandidateDashboard', icon: HomeIcon},
  { name: 'Shifts', routeAlias: 'CandidateShifts', icon: CalendarIcon  },
  { name: 'Timesheets', routeAlias: 'CandidateTimesheet', icon: ClipboardCheckIcon },
  { name: 'Wages', routeAlias: 'CandidateFinance', icon: CashIcon  },
  { name: 'Messages', routeAlias: 'CandidateNetwork', icon: ChatIcon  },
  // { name: 'Profile', routeAlias: 'CandidateProfile', icon: UserIcon  }
]

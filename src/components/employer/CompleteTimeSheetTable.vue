...
<script>
import Row from './Timesheet/CompleteRow.vue'
import Loader from '@common/Loader.vue'
import RowMobile from "./Timesheet/Row_mobile_Complete";
...
export default {
  ...
  computed: {
      ...mapGetters({
        getTimeSheet: "employer/getTimeSheet",
      }),
  },
  watch: {
          ...
          this.history_data=[];
            ...
            setTimeout(() => {
                this.table = $("#datatable").DataTable({
                   "language": {
                      "emptyTable": "You have no completed timesheets",
                      paginate: {
                                previous: '&#x2190; Previous',
                                next: 'Next &#x2192;',
                            },

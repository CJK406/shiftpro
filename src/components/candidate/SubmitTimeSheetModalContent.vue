<template>
 <Loader :loader_flag="loader_flag" />
  <div class="py-4 px-4">
      ...
      <p class="text-center text-gray-800 text-2xl mt-4 Biotif-bold">Confirm hours worked</p>
      ...
      <div class="justify-center flex">
        <button type="button"
            class="mt-4 mr-3 flex btn secondary_button ml-2" v-on:click="closeModal()"><XIcon class="w-5 mr-1 self-center" /> <span class="self-center">Close this window</span></button>
        <button @click="handleSubmit" type="submit" class="btn mt-4 primary_button">Send timesheet</button>
      </div>
    </div>
      <!-- </form> -->
  </div>
...
import {
  APIfetchDuration,APIdoSubmitTimesheet

        ...
        <div class="fixed inset-y-0 right-0 max-w-full flex">
          <TransitionChild as="template" enter="transform transition ease-in-out duration-500 sm:duration-700" enter-from="translate-x-full" enter-to="translate-x-0" leave="transform transition ease-in-out duration-500 sm:duration-700" leave-from="translate-x-0" leave-to="translate-x-full">
            <div class="w-screen max-w-md">
              <div class="h-full pt-20 flex flex-col py-2 bg-white shadow-xl overflow-y-scroll">
                  ...
                  <div class="py-3">
                    <div class="flex">
                        <div class="mr-4 flex-shrink-0 self-center">
                             <img class="inline-block h-14 w-14 rounded-full" v-bind:src="shift.photo" :alt="shift.company" />
                        </div>
                        <div>
                     ...
                     <div class="flex items-center pt-4">
                       <!-- <a class=" flex items-center p-3 text-gray-700  mr-2 border border-solid border-gray-200 rounded-3xl shadow-lg" href="/">
                          <UserIcon class="w-6 h-6" /> <span class="ml-2">Profile</span>
                       </a> -->
                       <button  type="button" style="background-color:#6fcba3" disabled="disabled"
                        ...
                        <button  type="button"
                          class="flex m-auto mt-2  hover:text-emerald secondary_button shadow-around-sm w-40 justify-center">
                            ...
                            <span class="ml-2 biotif-regular font-bold self-center">Cancel</span>
                        </button>
                       <!-- <button @click="viewProfile(shift.employer_id)" type="button"
                        class="flex m-auto mt-2 hover:text-emerald secondary_button shadow-around-sm w-40 justify-center">
                          <UserIcon class=" w-6 " > </UserIcon>
                          <span class="ml-2 biotif-regular font-bold self-center">View Profile</span>
                        </button>

                        <button @click="openModal( shift.employer_id, shift.photo, shift.employer_username)" type="button"
                          class="flex m-auto mt-2  hover:text-emerald secondary_button shadow-around-sm w-40 justify-center">
          ...
          <!-- <p class="flex items-center pb-2"><span class="text-gray-900 font-bold  mr-2">End time: </span><span class="">{{shift.end_time_formatted}}</span></p> -->
                  ...
                  <!-- Section --> 
                  <div class="py-6">
                    <h3 class="text-gray-900 font-bold  mr-2">Shift Description: </h3>
                    <div v-html="shift.description" class="text-base text-main-light">  </div>
                  </div>        
                  <div class="py-4 flex justify-center">
                    <!-- <button type="button" class="btn bg-emerald biotif-regular" v-on:click="action_accept('accepted')">Accept</button>
                    <button type="button" class="btn bg-red-500 biotif-regular ml-2" v-on:click="action_accept('rejected')">Reject</button> -->

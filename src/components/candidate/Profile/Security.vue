        ...
        <div class="grid lg:grid-cols-1 gap-8">
            <div class="grid lg:grid-col-1">
                ...
                <div class="grid lg:grid-cols-2 lg:w-full gap-8  mb-1">
                    <div>
                        <label class="block " style="color:#111827">New e-mail address</label>
                        <div class="mt-1">
                    ...
                    <div>
                        <label class="block " style="color:#111827">Repeat new e-mail address</label>
                        <div class="mt-1">
                ...
                <div class="grid lg:grid-cols-2 lg:w-full gap-8  mb-8">
                    <div>
                        <label class="block " style="color:#111827">New password</label>
                        <div class="mt-1">
                    ...
                    <div>
                        <label class="block " style="color:#111827">Repeat new password</label>
                        <div class="mt-1">
                ...
                <span class="self-center font-bold ml-2">E-mail notifications turned on</span>
                </div>
            </div>
            <div class="text-right">
          <button @click="save_change" class="btn primary_button lg:ml-auto h-10 pb-2 w-40 ml-auto mb-4 mt-4">
                Save changes
          </button>
        </div>
        </div>

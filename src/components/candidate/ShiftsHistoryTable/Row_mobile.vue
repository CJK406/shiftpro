<template>
    <div class="p-4 mobile_td" >
      <div class="flex items-center mb-3">
        ...
        <div class="text-sm ml-auto text-main-light">
          {{ shift.due_status }}  
        </div>
      </div>
      ...
      <div class="flex text-main-light items-center">
        ...
        <button @click="populatePanel_action" type="button" class="ml-auto focus:outline-none font-bold biotif-regular text-emerald hover:text-secondary-light">View Shift</button>

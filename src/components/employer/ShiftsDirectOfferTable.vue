...
<script>
import Row from "./ShiftsDirectOfferTable/Row";
import RowMobile from "./ShiftsDirectOfferTable/Row_mobile";
import VPagination from "@hennge/vue3-pagination";
import "@hennge/vue3-pagination/dist/vue3-pagination.css";
import RowPanel from "./ShiftsDirectOfferTable/RowPanel";
import { mapGetters, mapActions } from "vuex";
import { mixin as VueClickAway } from "vue3-click-away";
import {
  APIgetEmployerShiftsRequest,
...
export default {
    ...
    methods: {
        ...
        updatePagination() {
            this.page_data=[];
            let a = this.shift_data_backup.length<this.page*10 ? this.shift_data_backup.length :this.page*10;
            for(let i=(this.page-1)*10;  i<a; i++){
                this.page_data.push(this.shift_data_backup[i]);
            }
        },
        onClickAway2() {
    ...
    mounted() {
        ...
        this.loader_flag=true;
        APIgetEmployerShiftsRequest().then((res) => {
            this.loader_flag=false;

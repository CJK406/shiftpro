    ...
    <div class="flex flex-col">
        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8" >
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div class="overflow-hidden border-b border-gray-200 sm:rounded-lg" style="min-height:300px">
...
<script>
import Row from "./ShiftsYours/Row";
import RowMobile from "./ShiftsYours/Row_mobile";
    ...
    methods: {
        ...
        updateHandler() {
            ...
            for (let i = 0; i < this.filteredShifts.length; i++) {
                if(this.filteredShifts[i]["role"].includes(this.shift_filter)){

<template>
    <div class="p-4 mobile_td" >
      ...
      <div class="flex text-main-light items-center">
        ...
        <button @click="populatePanel_action" type="button" class="ml-auto focus:outline-none font-bold biotif-regular " :class="{'text-gray-400': shift.applied,'text-emerald hover:text-secondary-light' : !shift.applied }">{{actionType!=="dashboard" ? "View" : !shift.applied ? "View" : "Applied"}}</button>
